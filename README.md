...
How to run it:
From Google you need the application name. 
in app.yaml place your application name (the once you get from google app engine console )

From shopify you need the developer key and secret. 
place the key and secret in bp_content/themes/default/config/localhost/

run dev_appserver (see instructions on google appengine python)

create a user localhost:8080
in the admin localhost:8000 make the Datastore Viewer in User, change your user to Acitvated.
